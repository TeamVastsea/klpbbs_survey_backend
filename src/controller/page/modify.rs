...
pub async fn new_page(
    ...
    Json(query): Json<CreatePageRequest>,
) -> String {
...
pub async fn delete_page(
    ...
    info!("Admin {} delete page {}", admin.uid, id);

    let result = page::Entity::delete_by_id(id)
        .exec(&*crate::DATABASE)
        .await
        .map_err(|e| ErrorMessage::DatabaseError(e.to_string()))?;
